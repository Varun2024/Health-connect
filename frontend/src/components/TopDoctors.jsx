...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 pt-10 bg-orange-100 text-gray-500 md:mx-15 shadow-xl rounded-lg pb-8'>
      ...
      <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className='flex flex-row bg-orange-500 text-white px-12 py-2 rounded-full mt-9 hover:bg-white hover:text-orange-500 gap-3 hover:shadow-md transition-all ease-in-out duration-100 hover:delay-300 hover:shadow-orange-500 hover:scale-105 '>More</button>
    </div>
  );
};
