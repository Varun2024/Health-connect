  ...
  return (
    <div className='md:mx-15 rounded-md'>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div className='bg-orange-500 text-white px-5 rounded-lg hover:scale-110 transition-all duration-200 delay-130 hover:shadow-lg'>
        ...
        <div className='bg-gray-900 px-5 rounded-lg hover:scale-110 transition-all duration-200 delay-130 hover:shadow-lggit'>
